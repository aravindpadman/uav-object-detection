...
class TensorboardWriter(object):
    ...
    def __init__(self, cfg):
        ...
        if cfg.TENSORBOARD.LOG_DIR == "":
            log_dir = os.path.join(cfg.OUTPUT_DIR, "logdir")
            
        else:
            log_dir = os.path.join(cfg.OUTPUT_DIR, cfg.TENSORBOARD.LOG_DIR)

        tensorboard_comment = None
        self.writer = SummaryWriter(log_dir=log_dir, comment=tensorboard_comment, max_queue=100)
        print(
