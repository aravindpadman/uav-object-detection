...
def fasterrcnn_resnet50_fpn(
    ...
    backbone = resnet50(pretrained=pretrained_backbone, progress=progress, norm_layer=FrozenBatchNorm2d)
...
def _fasterrcnn_mobilenet_v3_large_fpn(
    ...
    **kwargs,
    ...
    backbone = mobilenet_v3_large(
        pretrained=pretrained_backbone, progress=progress, norm_layer=FrozenBatchNorm2d
    )
